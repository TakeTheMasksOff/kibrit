...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <div class="col-sm-4">
		<?php echo $form->labelEx($model,'fill'); ?>
		<?php echo $form->textField($model,'fill',array('size'=>60,'maxlength'=>255,'class'=>'form-control input-lg')); ?>
		<?php echo $form->error($model,'fill'); ?>
	</div>
