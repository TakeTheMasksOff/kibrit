...
<div class="logopanel">
    <h1><?php echo CHtml::link(CHtml::image(Yii::app()->baseUrl.'/template/images/logo.png'),$this->createUrl('site/index'));?></h1>
</div>
...
<div class="leftpanelinner">    
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket sidebaritems">
        ...
        <!--<li class=""><a data-module="brands" href="<?=$this->createUrl('brands/admin');?>"><i class="fa-credit-card fa"></i> <span>Brands</span></a></li>-->
