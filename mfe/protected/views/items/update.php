                                    ...
                                    <div class="">
                                            <?php foreach($model->category->fields as $fieldset):?>
                                                ...
                                                <div class="col-sm-12">
                                                        ...
                                                        <?php //echo CHtml::textField("ItemsParamset[{$key}][{$fieldset->id}]",$field->value,array('id'=>"ItemsParamset_{$key}_{$fieldset->id}", 'class'=>'form-control input-lg')); ?>
                                                        <?php $this->widget('zii.widgets.jui.CJuiAutoComplete',array(
                                                                                'name'=>"ItemsParamset[{$key}][{$fieldset->id}]",
                                                                                'sourceUrl'=>$this->createUrl('items/paramsetTamamla',array('language'=>$key,'id'=>$fieldset->id,'')),
