...
class elRTE extends CInputWidget
{
   ...
   public function run()
   {
      ...
      //$clientScript->registerCssFile($baseUrl.'/css/smoothness/jquery-ui.min.css');
      //$clientScript->registerCssFile($baseUrl.'/css/smoothness/jquery-ui.theme.min.css');
...
//				toolbar  : 'maxi',
    ...
    $this->options['absoluteURLs'] = false;
    if (empty($this->options['toolbar']))
        $this->options['toolbar'] = 'maxi';
    if (empty($this->options['cssClass']))
        $this->options['cssClass'] = 'el-rte';
      ...
      if(!empty($this->options['cssfiles']))
      {
         ...
         $this->options['cssfiles'] = $css_paths;
          ...
          $this->options['cssfiles'][] = $baseUrl.'/css/elrte-inner.css';
      }
      //from here
      $elfopts = "";
