			...
			$model->attributes=$_POST['Banners'];
                        if (isset($_FILES['Banners'])){
                            ...
                            if ($model->thumbnail!=NULL){
                                ...
                                $timeNow = time();
                                $path = Yii::app()->basePath . $this->basePath . $timeNow. $model->thumbnail->name;

                                $model->thumbnail->saveAs($path);
                                $model->thumbnail = $timeNow.$model->thumbnail->name;
                            }
                        }
			if($model->save())
