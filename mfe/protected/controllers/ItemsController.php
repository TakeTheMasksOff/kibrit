            ...
            if (isset($_POST['ImportForm'])){
                ...
                if (isset($_FILES['ImportForm'])){
                    ...
                    if ($model->file){
                        ...
                        @mkdir($path, 0754);
                        @mkdir($path.strtolower($this->module), 0754);
                        $model->file->saveAs($path.  strtolower($this->module).'/'.$time.'_'.$model->file->name,false);
                    }
                }
                if ($model->validate()){
