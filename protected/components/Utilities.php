...
class Utilities{
    ...
    static function t($str,$arr=array(),$source=null,$language=null){
        return Yii::t('frontend.strings',$str,$arr,$source,$language);
    }
    static function getSQL($model,$crit){
        $modelName = get_class($model);
        $modelName::model()->tableName();
        return $modelName::model()->getCommandBuilder()->createFindCommand($modelName::model()->tableName(), $crit)->getText();
    }
