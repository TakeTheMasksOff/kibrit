...
class ShopOrder extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('order_id, customer_id, ordering_date, ordering_done, ordering_confirmed, shipped, finished, cancelled, transaction_id, shipping_fee, shipping_name, shipping_surname, address, email, phone, message, payment_method, ip', 'safe', 'on'=>'search'),
		);
	}
