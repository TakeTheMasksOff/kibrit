...
class Articles extends Translatable
{
	...
	public function search()
	{
        ...
        public function getLink($lang){
            ...
            if ($this->type!='static'){
                return Yii::app()->controller->createUrl('site/article',
                                                        array('language'=>$lang,
                                                                'id'=>$this->id,
                                                                'name'=>  Utilities::str2url($this->getTranslation($lang)->name)
                                                        )
                        );
            } else {
                return $this->parent->getTranslation($lang)->getLink($lang);
            }
        }
}
