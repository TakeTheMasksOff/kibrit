...
class CategoryTranslate extends CActiveRecord
{
	...
	public static function model($className=__CLASS__)
	{
        ...
        public function getLink($lang,$id){
            if (($this->parent  and  $this->parent->main) or (isset($this->parent) && isset($this->parent->parent) && $this->parent->parent and $this->parent->parent->main)) return Yii::app()->createUrl('site/velos',array('id'=>$id,'language'=>$lang));
            else return Yii::app()->createUrl('site/extras',array('id'=>$id,'language'=>$lang));
        }
}
