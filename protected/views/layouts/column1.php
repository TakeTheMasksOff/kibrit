...
<div id="myNav" class="overlay">
    <dl id="sample" class="dropdown">
        <dt> <i class="icon-angle-down"></i><a href="#"><span>
                    <?php echo $this->languages[$this->Lang]; ?></span></a>
        </dt>
        <dd>
            <?php $langs = array();
            ...
            <ul>
                ...
                <li class="valued" <?php if ($this->languages[$this->Lang] === $lang) : ?> style="display:none"
                    <?php endif; ?>>
                    <?php $tmp['language'] = $code;
                    echo CHtml::link($lang, $this->createUrl($controller->id . '/' . $this->action->id, $tmp)); ?>
                </li>
                <?php endforeach; ?>
            </ul>
        </dd>
    ...
    <div class="overlay-content">
        <?php 
        $menusWith = array(
            'translations' => array('together' => true),
    ...
    <div class="footer-block">
        <p>
            <?php echo CHtml::link('Sitemap', $this->createAbsoluteUrl($this->Lang . '/sitemap')); ?>
        </p>
        <p>
