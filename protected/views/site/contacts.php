  ...
  <div class="container-fluid">
      ...
      <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
            ...
            <form method="post" action='<?php echo $this->createUrl('site/contacts',array('language'=>$this->Lang));?>'>
          ...
          <div class="col-md-2 col-lg-2 bottom-padding contacts-page <?=$this->Lang?>">
              ...
              <div itemscope itemtype="http://schema.org/Organization"> 
                ...
                <br>
              <a class="link" href="javascript:void(0)" onclick="openGmapBlock()"><?php echo Yii::t('frontend.strings','Show on map');?></a>
