    ...
    <div class="container-fluid assets-block">
        <div class="row justify-content-center title-block mx-md-3">
            <div class="col-md-9 col-lg-12">
                <div class="title">
                    <h1 class="pageName"><?php echo $model->parent->getTranslation($this->Lang)->name;?></h1>
            ...
            <div class="col-12 col-md-3 col-lg-4 d-none d-md-block">
                ...
                <div class="mr-lg-5" id="sidebar-wrapper">
                    <ul class="sidebar-nav">
                        <?php $i=1;foreach($model->parent->articles(array('order'=>'articles.sort asc','scopes'=>array('active'))) as $item):?>
                        <li>
        ...
        <div class="container">
            <div class="content-block" class="mb20">
                ...
                >
                    ...
                    <form id="requestForm" method="post" class="requestForm"
                        action='<?php echo $this->createUrl('site/services/',array('language'=>$this->Lang,'detail'=>$detail, 'utm'=>$detail));?>'>
