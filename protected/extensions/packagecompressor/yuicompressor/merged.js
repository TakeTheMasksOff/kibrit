...
$(document).ready(function(){;
		var seoHrefs = {'f34bb62f734d1cecaa4de6a8b8efab53':'aHR0cDovL3d3dy5kc2MuYXov', 
						'f34bb62f734d1cecaa4de6a8b8efab52':'aHR0cDovL3d3dy5zaW1icmVsbGEuY29t',
...
(function($) {
	...
	$(document).ready(function() {
        	...
        	if ($("#cssmenu .has-sub li").hasClass("active")) {
				$('li.has-sub > a').next().css("display","block");
        	}
		...
		- - - - - - - - - - - - - - - - - - - - */
		$("#menu ul").hide();
		$("#menu li span").click(function() { $(this).next().slideToggle("fast"); $(this).toggleClass("active"); });
