...
class Image {
	...
	{
            $this->_driver->resizeCanvas($toWidth, $toHeight, $backgroundColor);
            return $this;
	}
	public function thumb($module){
                $picAspect = $this->width/$this->height;// 1000/500=2 100/40=2.5 
                if ($module->height)
...
//                if ($module->fill!='')
                    $this->resizeCanvas(10000,10000,  Utilities::hex2rgb('#ff0000'));
                    
                    $this->resize($module->width,$module-height);
            return $this;
        }
	/**
