...
//                ),
        ...
        $request['message']['to'] = isset($data['to'])?$data['to']:array(array('email'=>$data['to_email'],'type'=>'to'));
        $request['message']['attachments'] = (isset($data['attachments']))? $data['attachments']:array();
